...
>[!NOTE]
>As usual, please clone the repository first.
...
>[!IMPORTANT]
>Check the current location at the windows top. If you're inside the project folder (ends on ".X") you need to go up a level. You can use the leftmost button on the top right side of the window to do that.
...
Now we need a new C Source File. Therefore, we right click again on "Source Files" in our Projects view, select New, and then Other...
![](images/106_add_c_file.png)

Now select "C" as Category, "C Source File" as File Type and click "Next>".
![](images/107_add_c_file.png)

No we need to give our file a meaningful name, such as "uC_Config" and click finish to add it.
...
>[!NOTE]
>If not already done, connect the PICkit3 to your development board.
...
>[!IMPORTANT]
>If you don't have a watch tab as shown below, you can open it. Use MPLAB's menu at the top of the IDE. And open the Watches view using Window -> Debugging -> Watches.
